  ...
  describe('hitTest() inclusive', () => {
    ...
    for (
      ...
      it(`should hit when devicePixelRatio=${devicePixelRatio}`, () => {
        ...
        const sprites = [
          [-0.2, 0.2], // Index 0 = Top left.
          [0.2, 0.2], // Index 1 = Top right.
          [-0.2, -0.2], // Index 2 = Bottom left.
          [0.2, -0.2], // Index 3 = Bottom right.
        ].map((position) => {
          const sprite = scene.createSprite();
          sprite.enter((s: SpriteView) => {
            s.BorderColorOpacity = 0.4;
  ...
  describe('hitTest() exclusive', () => {
    ...
    for (
      ...
      it(`should hit when devicePixelRatio=${devicePixelRatio}`, () => {
        ...
        // Create four overlapping sprites.
        const sprites = [
          [-0.25, 0.25], // Index 0 = Top left.
          [0.25, 0.25], // Index 1 = Top right.
          [-0.25, -0.25], // Index 2 = Bottom left.
          [0.25, -0.25], // Index 3 = Bottom right.
        ].map((position) => {
          const sprite = scene.createSprite();
          sprite.enter((s: SpriteView) => {
            s.BorderColorOpacity = 0.4;
